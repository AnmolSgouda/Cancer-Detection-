...
const char* password = "anmol@1234";         // Provide Password


const char* host ="a2qj72ejotvwiu-ats.iot.eu-north-1.amazonaws.com"; //AWS IoT Core--> Settings (Device data endpoint)
